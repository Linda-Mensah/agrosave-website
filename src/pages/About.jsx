...
const PLANT_IMAGE =
  "https://plus.unsplash.com/premium_photo-1680322763961-b02b8e4ea829?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzN8fGJsYWNrJTIwcGVyc29uJTIwaGFuZCUyMGhvbGRpbmclMjBzZWVkbGluZyUyMGluJTIwc29pbHxlbnwwfHwwfHx8MA%3D%3D";
          ...
          <div className="values-grid">
            <div className="value-item sustainability">
              <div className="value-content">
                ...
                <p>
                  Environmentally friendly solutions that reduce carbon
                  footprint.
                </p>
              </div>
            </div>
            <div className="value-item innovation">
              <div className="value-content">
                ...
                <h3>Innovation</h3>
                <p>
                  Continuous improvement of technology to better serve farmers.
                </p>
              </div>
            </div>
            <div className="value-item community">
              <div className="value-content">
                ...
                <h3>Community</h3>
                <p>
                  Strengthening local food systems and supporting rural
                  communities.
                </p>
              </div>
            </div>
            ...
            <div className="value-item quality">
              <div className="value-content">
                ...
                <h3>Quality</h3>
                <p>
                  Delivering premium cold storage solutions that meet the
                  highest standards.
                </p>
              </div>
            </div>
            <div className="value-item partnership">
              <div className="value-content">
                ...
                <h3>Partnership</h3>
                <p>
                  Building strong collaborations with farmers, markets, and
                  communities.
                </p>
              </div>
            </div>
      ...
      <section className="team-impact">
        <div className="container">
          <div className="impact-highlight">
            ...
            <p>
              Join us in building a more sustainable and equitable food system
              for Ghana.
            </p>
          </div>
        </div>
